...
|     Scenario    |     Unprotected left turn    |             |                |              |     Double Merge    |             |                |              |     CARLA    |             |                |             |
|-----------------|------------------------------|-------------|----------------|--------------|---------------------|-------------|----------------|--------------|--------------|-------------|----------------|-------------|
|     Methods     |     Succ.                    |     Col.    |     Step(s)    |     Ret.     |     Succ.           |     Col.    |     Step(s)    |     Ret.     |     Succ.    |     Col.    |     Step(s)    |     Ret.    |
|     PPO-R1      |     0.48                     |     0.38    |     20.4       |     0.10     |     0.38            |     0.62    |     33.7       |     -0.34    |     0.44     |     0.20    |     22.1       |     0.24    |
|     DrQ-R1      |     0.70                     |     0.30    |     27.3       |     0.40     |     0.66            |     0.14    |     38.3       |     0.52     |     0.74     |     0.24    |     17.6       |     0.46    |
|     Ours-R1     |     0.90                     |     0.10    |     11.7       |     0.80     |     0.84            |     0.16    |     21.2       |     0.68     |     0.76     |     0.22    |     19.4       |     0.54    |
|     PPO-R2      |     0.38                     |     0.62    |     31.2       |     -0.20    |     0.46            |     0.54    |     34.7       |     -0.08    |     0.5      |     0.2o    |     24.8       |     0.30    |
|     DrQ-R2      |     0.82                     |     0.08    |     13.9       |     0.74     |     0.72            |     0.28    |     18.7       |     0.44     |     0.78     |     0.12    |     18.5       |     0.66    |
|     Ours-R2     |     0.94                     |     0.04    |     11.6       |     0.90     |     0.88            |     0.10    |     27.7       |     0.78     |     0.78     |     0.16    |     21.3       |     0.62    |
